...
<head>
    ...
    <title>Chi tiết giao dịch - Marketplace</title>
        ...
        <div class="transaction-header text-center">
            <div class="row align-items-center">
                ...
                <div class="col-md-8">
                    <h2 class="mb-2">
                        <c:choose>
                            <c:when test='${transaction.type == "DEPOSIT"}'>Giao dịch nạp tiền</c:when>
                            <c:when test='${transaction.type == "WITHDRAWAL"}'>Giao dịch rút tiền</c:when>
                            <c:when test='${transaction.type == "PAYMENT"}'>Giao dịch thanh toán</c:when>
                            <c:when test='${transaction.type == "REFUND"}'>Giao dịch hoàn tiền</c:when>
                            <c:otherwise>Giao dịch chuyển khoản</c:otherwise>
                        </c:choose>
                    </h2>
                ...
                <div class="card detail-card">
                    <div class="card-body text-center">
                        ...
                        <div class="amount-display 
                            <c:choose>
                                <c:when test='${transaction.type == "DEPOSIT" || transaction.type == "REFUND"}'>amount-positive</c:when>
                                <c:otherwise>amount-negative</c:otherwise>
                            </c:choose>">
                            
                            <c:choose>
                                <c:when test='${transaction.type == "DEPOSIT" || transaction.type == "REFUND"}'>+</c:when>
            ...
            <div class="col-md-6 mb-4">
                <div class="card detail-card">
                    <div class="card-body">
                        ...
                        <div class="info-row">
                            <div class="row">
                                <div class="col-5 info-label">Mã giao dịch:</div>
                                <div class="col-7">
                                    <c:choose>
                                ...
                                <div class="col-7">
                                    <span class="badge bg-primary">
                                        <c:choose>
                                            ...
                                            <c:when test='${transaction.type == "WITHDRAWAL"}'>Rút tiền</c:when>
                        ...
                        <c:if test="${transaction.updatedAt != null && transaction.updatedAt != transaction.createdAt}">
                            <div class="info-row">
                                <div class="row">
                    ...
                    <div class="card detail-card">
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    <p class="mb-1"><strong>Mã đơn hàng:</strong> #${transaction.order.id}</p>
                                    <p class="mb-0 text-muted">
                                        Ngày tạo: ${fn:substring(transaction.order.createdAt, 0, 10)}
                                    </p>
                                </div>
                                <a href="/orders/${transaction.order.id}" class="btn btn-outline-primary">
            ...
            <div class="col-12 text-center">
                ...
                <c:if test='${transaction.paymentStatus == "SUCCESS" && transaction.type == "DEPOSIT"}'>
                    <a href="/wallet/deposit" class="btn btn-success">
                        <i class="fas fa-plus"></i> Nạp tiền thêm
                    </a>
                </c:if>
            </div>
        </div>
