...
<body>
                    ...
                    <div class="card detail-card">
                        <div class="card-body p-4">
                            ...
                            <div class="user-info-card">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <p><strong>Tên:</strong> ${withdrawal.user.fullName}</p>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <p><strong>Số dư hiện tại:</strong> 
                                            <fmt:formatNumber value="${withdrawal.user.balance}" type="currency" currencySymbol="" /> ₫
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="text-center mb-4 py-4 bg-light rounded">
                                ...
                                <div class="amount-display">
                                    <fmt:formatNumber value="${withdrawal.amount}" type="currency" currencySymbol="" /> ₫
                                </div>
                            </div>
                ...
                <form id="rejectForm" method="post" action="/admin/withdrawals/${withdrawal.id}/reject">
                    ...
                    <div class="modal-body">
                        <div class="alert alert-warning">
                            ...
                            Số tiền <strong><fmt:formatNumber value="${withdrawal.amount}" type="currency" currencySymbol="" /> ₫</strong> 
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="rejectReason" name="reason" rows="4" 
                                      placeholder="Nhập lý do từ chối yêu cầu rút tiền..." required></textarea>
    ...
    <!-- Approve Form (hidden) -->
    <form id="approveForm" method="post" action="/admin/withdrawals/${withdrawal.id}/approve" style="display: none;">
        <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}" />
    </form>
