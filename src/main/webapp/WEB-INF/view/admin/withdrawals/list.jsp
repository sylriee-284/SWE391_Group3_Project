                                                ...
                                                <nav aria-label="Phân trang">
                                                    <ul class="pagination mb-0 justify-content-center">
                                                        ...
                                                        <li class="page-item ${currentPage == 0 ? 'disabled' : ''}">
                                                            <a class="page-link"
                                                                href="?page=0&status=${selectedStatus}&fromDate=${param.fromDate}&toDate=${param.toDate}"
                                                                aria-label="First">
                                                        ...
                                                        <li class="page-item ${currentPage == 0 ? 'disabled' : ''}">
                                                            <a class="page-link"
                                                                href="?page=${currentPage - 1}&status=${selectedStatus}&fromDate=${param.fromDate}&toDate=${param.toDate}"
                                                                aria-label="Previous">
                                                        ...
                                                        <c:forEach begin="${currentPage > 2 ? currentPage - 2 : 0}"
                                                            ...
                                                            <li class="page-item ${currentPage == i ? 'active' : ''}">
                                                                <a class="page-link"
                                                                    href="?page=${i}&status=${selectedStatus}&fromDate=${param.fromDate}&toDate=${param.toDate}">${i
                                                                    +
                                                                    1}</a>
                                                            </li>
                                                        </c:forEach>
                                                        ...
                                                        <c:if test="${currentPage + 2 < totalPages - 1}">
                                                            <li class="page-item">
                                                                <a class="page-link"
                                                                    href="?page=${totalPages - 1}&status=${selectedStatus}&fromDate=${param.fromDate}&toDate=${param.toDate}">${totalPages}</a>
                                                            </li>
                                                        </c:if>
                                                        ...
                                                        <li
                                                            class="page-item ${currentPage == totalPages - 1 ? 'disabled' : ''}">
                                                            <a class="page-link"
                                                                href="?page=${totalPages - 1}&status=${selectedStatus}&fromDate=${param.fromDate}&toDate=${param.toDate}"
                                                                aria-label="Last">
