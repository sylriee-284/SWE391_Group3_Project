                                ...
                                <div class="col-md-3">
                                    <select class="form-select" name="parentCategoryId" onchange="this.form.submit()"
                                        ...
                                        <c:forEach var="pc" items="${parentCategories}">
                                            <option value="${pc.id}" <c:if test="${parentCategoryId == pc.id}">
                                                selected
                                                </c:if>>${pc.name}</option>
                                        </c:forEach>
                                    </select>
                                ...
                                <div class="col-md-2">
                                    <select class="form-select" name="categoryId" aria-label="Danh mục">
                                        ...
                                        <c:forEach var="c" items="${subCategories}">
                                            <option value="${c.id}" <c:if test="${categoryId == c.id}">
                                                selected</c:if>
                                                >${c.name}</option>
                                        </c:forEach>
                                    </select>
                                            ...
                                            <div class="row mb-3">
                                                <div class="col-md-4">
                                                    <div class="detail-item">
                                                        ...
                                                        <div class="detail-value text-success fw-bold" id="d-price">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="detail-item">
                                                        <label class="detail-label">Số lượng hiện
                                                            tại:</label>
                            ...
                            <div class="modal-dialog modal-lg modal-dialog-centered">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form id="editForm" enctype="multipart/form-data">
                                            ...
                                            <div class="product-form-grid">
                                                <div class="product-form-group">
                                                    ...
                                                    <input type="text" class="product-form-control form-control"
                                                        id="e-name" name="name" required maxlength="120">
                                                </div>

                                                <div class="product-form-group">
                                                    <label class="product-form-label">Slug</label>
                                                    <input type="text" class="product-form-control form-control"
                                                        id="e-slug" name="slug" required maxlength="120">
                                                    <div class="product-form-text">Chỉ a-z, 0-9, dấu gạch
                                                        ngang (-), 2–120
                                                        ký tự.</div>
                                                </div>

                                                <div class="product-form-group">
                                                    <label class="product-form-label">Tùy chọn danh
                                                        mục</label>
                                                    <select class="product-form-select form-select"
                                                        id="e-parentCategory">
                                                        <option value="">-- Tùy chọn danh mục --</option>
                                                        <c:forEach var="pc" items="${parentCategories}">
                                                ...
                                                <div class="product-form-group product-form-full-width">
                                                    <label class="product-form-label">Ảnh đại diện sản
                                                        phẩm</label>
                                                    <input class="product-form-control form-control" type="file"
                                                        id="e-imageFile" name="imageFile"
                                                        accept="image/jpeg,image/png" />
                                                    <div id="e-currentImage" class="mt-2"></div>
                                                    <div class="product-form-text">Chỉ JPG/PNG, tối đa 10MB.
                                                    </div>
                                                </div>

                                                <div class="product-form-group product-form-full-width">
                                                    <label class="product-form-label">Mô tả</label>
                                                    <textarea class="product-form-control form-control"
                                                        id="e-description" name="description" rows="4"
                                                        maxlength="200"></textarea>
                                                </div>

                                                <div class="product-form-group">
                                                    <label class="product-form-label">Số lượng hiện
                                                        tại:</label>
                                        ...
                                        <small class="text-muted">* Lưu trong modal sẽ gọi endpoint AJAX;
                                            nếu muốn chỉnh sửa
                        ...
                        <script>
                            (function () {
                                ...
                                function vPriceRange() {
                                    ...
                                    if (minVal != null && isNaN(minVal)) { minEl.setCustomValidity('invalid'); return false; }
                                    if (maxVal != null && isNaN(maxVal)) { maxEl.setCustomValidity('invalid'); return false; }
                                    if (minVal != null && maxVal != null && maxVal < minVal) { maxEl.setCustomValidity('max-less-than-min'); return false; }
                                    minEl && minEl.setCustomValidity(''); maxEl && maxEl.setCustomValidity(''); return true;
                                }
                                function vIdRange() {
