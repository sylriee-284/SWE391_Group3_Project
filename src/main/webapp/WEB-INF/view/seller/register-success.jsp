        ...
        <%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
            <%@ taglib prefix="fn" uri="http://java.sun.com/jsp/jstl/functions" %>
                ...
                <head>
                    ...
                    <link rel="stylesheet"
                        href="${pageContext.request.contextPath}/resources/css/register-success.css" />
                        ...
                        <div class="container-fluid px-5">
                            <div class="success-container">
                                ...
                                <c:if test="${not empty info}">
                                    <div id="serverInfo" data-info="${fn:escapeXml(info)}"></div>
                                </c:if>
                                    ...
                                    <div class="col-lg-9">
                                        <div class="card mb-3 shadow-sm highlight-card">
                                            <div class="card-body">
                                                ...
                                                <div class="mt-3">
                                                    <p class="mb-1">Số tiền ký quỹ: <strong class="text-success">
                                                            <fmt:formatNumber value="${store.depositAmount}"
                                                                type="number" pattern="#,###" /> VNĐ
                                                        </strong></p>
                                                    <p class="mb-0">Giá niêm yết tối đa: <strong>
                                                ...
                                                <div class="mt-3">
                                                    <div class="card border-0 shadow-sm">
                                                        <div class="card-header bg-primary bg-gradient text-white">
                                                            <h6 class="mb-0"><i
                                                                    class="fas fa-file-contract me-2"></i>Điều khoản hợp
                                                                đồng</h6>
                                                        </div>
                                                        <div class="card-body">
                                                            <c:choose>
                                                                <c:when test="${store.feeModel == 'PERCENTAGE'}">
                                                                    ...
                                                                    <div class="mb-3">
                                                                        <h6 class="text-primary">
                                                                            <i class="fas fa-percent me-2"></i>Phí theo
                                                                            phần trăm
                                                                            <span class="badge bg-info ms-2">Khuyến
                                                                                nghị</span>
                                                                        </h6>
                                                                    </div>

                                                                    <div class="mb-3">
                                                                        <p class="mb-2"><strong>Hệ thống sẽ áp dụng mức
                                                                                phí giao dịch dựa trên giá trị đơn hàng
                                                                                như sau:</strong></p>
                                                                        <ul class="list-unstyled ms-3">
                                                                            ...
                                                                            <li class="mb-2">
                                                                                ...
                                                                                Đơn hàng từ <strong>100.000 VNĐ</strong>
                                                                                trở lên → Phí theo tỷ lệ: <strong
                                                                                    class="text-danger">
                                                                                    <fmt:formatNumber
                                                                                        value="${percentageFee}"
                                                                                        type="number"
                                                                    ...
                                                                    <div class="alert alert-success border-0 mb-0">
                                                                        ...
                                                                        <ul class="mb-2 small">
                                                                            <li>Nếu cửa hàng đóng <strong>sau
                                                                                    ...
                                                                                    tháng</strong> kể từ ngày kích hoạt
                                                                                → hoàn <strong class="text-success">
                                                                                    <fmt:formatNumber
                                                                                        value="${percentageMaxRefundRate}"
                                                                                        type="number"
                                                                                        maxFractionDigits="0" />% phí ký
                                                                                    quỹ
                                                                                </strong>.</li>
                                                                            <li>Nếu cửa hàng đóng <strong>trước
                                                                                    ${maxRefundRateMinDuration}
                                                                                    tháng</strong> → hoàn <strong
                                                                                    class="text-warning">
                                                                                    <fmt:formatNumber
                                                                        ...
                                                                        <p class="mb-0 small fst-italic">
                                                                            ...
                                                                            💡 Chính sách này đảm bảo tính công bằng,
                                                                            khuyến khích hoạt động lâu dài và bảo vệ
                                                                ...
                                                                <c:otherwise>
                                                                    ...
                                                                    <div class="mb-3">
                                                                        <h6 class="text-muted">
                                                                            <i class="fas fa-circle me-2"></i> Không
                                                                            tính phí
                                                                        </h6>
                                                                    </div>
                                                                    ...
                                                                    <div class="mb-3">
                                                                        <ul class="list-unstyled ms-3">
                                                                            <li class="mb-2">
                                                                                ...
                                                                                Người bán <strong>không phải trả bất kỳ
                                                                                    khoản phí giao dịch nào</strong> cho
                                                                                các đơn hàng.
                                                                            </li>
                                                                            <li class="mb-2">
                                                                                <i
                                                                                ...
                                                                                <strong>100%</strong> vào ví hệ thống
                                                                                của người bán.
                                                                            </li>
                                                                        </ul>
                                                                    </div>
                                                                    ...
                                                                    <div class="alert alert-warning border-0 mb-0">
                                                                        ...
                                                                        <p class="mb-0 small fst-italic">
                                                                            <i
                                                                                class="fas fa-lightbulb text-warning me-1"></i>
                                                                            💡 Phù hợp với các cửa hàng nhỏ, thử nghiệm
                                                                            hoặc hoạt động ngắn hạn, ưu tiên đơn giản và
                                                                            không phát sinh phí giao dịch.
                                                                        </p>
                                                                    </div>
                                                                </c:otherwise>
                                                            </c:choose>
                                                ...
                                                <c:if test="${store.status == 'PENDING'}">
                                                    <div class="alert alert-info mt-3" id="pendingAlert">
                                                        ...
                                                        <strong>Cửa hàng đang chờ kích hoạt.</strong> Vui lòng bấm nút
                                                        bên dưới để thanh toán ký quỹ và kích hoạt cửa hàng.
                                                    </div>
                                                    ...
                                                    <div class="mt-3 d-grid" id="activateButtonContainer">
                                                        <form
                                                            ...
                                                            <button type="submit" class="btn btn-success btn-sm"><i
                                                                    class="fas fa-check-circle"></i> Kích hoạt</button>
                                                        </form>
                                                    </div>
                                                </c:if>
                                            </div>
                            ...
                            <c:if test="${store.status == 'ACTIVE'}">
                                <div class="text-center mt-4">
                                    <a href="/seller/products" class="btn btn-primary btn-lg me-2">
