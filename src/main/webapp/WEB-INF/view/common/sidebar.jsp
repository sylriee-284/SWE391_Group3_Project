                        ...
                        <sec:authorize access="isAuthenticated() and hasRole('SELLER')">
                            ...
                            <li class="mt-2">
                                ...
                                <ul class="collapse list-unstyled ms-3 mt-2" id="sellerMenu">
                                    <li><a href="/seller/dashboard" class="text-white text-decoration-none">📊 Bảng điều
                                            khiển người bán</a></li>
                                    <li><a href="/seller/store-info" class="text-white text-decoration-none">🏪 Thông
                                            tin
                                            cửa hàng</a></li>
                                    <li><a href="/seller/products" class="text-white text-decoration-none">📦 Quản lý
                                            sản
                                            phẩm</a></li>
                                    <li><a href="/seller/reports" class="text-white text-decoration-none">📈 Báo cáo &
                                            thống
                                            kê</a></li>
                                </ul>
                            </li>
                        ...
                        <sec:authorize access="hasRole('ADMIN')">
                            ...
                            <li class="mt-2">
                                ...
                                <ul class="collapse list-unstyled ms-3 mt-2" id="adminMenu">
                                    <li><a href="#" class="text-white text-decoration-none">📊 Bảng điều
                                            khiển Admin</a></li>
                                    ...
                                    <li><a href="/admin/categories"" class=" text-white text-decoration-none">📦 Quản lý
                                            mặt
                                            hàng</a></li>
                                    ...
                                    <li><a href="#" class="text-white text-decoration-none">📈 Báo cáo & thống kê</a>
                                    </li>
                                </ul>
                            </li>
                        </sec:authorize>
