                                                ...
                                                <ul class="pagination justify-content-center">
                                                        ...
                                                        <c:when test="${!hasPrevious}">
                                                            <li class="page-item disabled" aria-disabled="true">
                                                                <span class="page-link"><i
                                                                        class="fas fa-chevron-left"></i> Trước</span>
                                                            </li>
                                                        </c:when>
                                                        <c:otherwise>
                                                            <c:url var="prevUrl"
                                                            ...
                                                            <li class="page-item">
                                                                <a class="page-link" href="${prevUrl}"><i
                                                    ...
                                                    <c:forEach begin="0" end="${totalPages - 1}" var="pageNum">
                                                        <c:if
                                                            ...
                                                            <li
                                                                ...
                                                                <a class="page-link" href="${pageUrl}">${pageNum +
                                                                    1}</a>
                                                            </li>
                                                        </c:if>
                                                    </c:forEach>
                                                    ...
                                                    <c:choose>
                                                        ...
                                                        <c:otherwise>
                                                            ...
                                                            <li class="page-item">
                                                                <a class="page-link" href="${nextUrl}">Sau <i
