                                                                ...
                                                                <div class="card border-success">
                                                                    <div class="card-body text-center">
                                                                        ...
                                                                        <h2 class="card-title text-success">
                                                                            ${parentCategory.name}</h2>
                                                                        <p class="card-text">
                                                                            ${parentCategory.description}</p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <<<<<<< HEAD <!-- Filter and Search Section -->
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-3 mb-3">
                                                                                <label for="childCategory"
                                                                                    class="form-label">Danh mục
                                                                                    con:</label>
                                                                                <select class="form-select"
                                                                                    id="childCategory"
                                                                                    name="childCategory">
                                                                                    <option value="">Tất cả danh mục con
                                                                                    </option>
                                                                                    <c:forEach var="childCat"
                                                                                        items="${childCategories}">
                                                                                        <option value="${childCat.id}"
                                                                                            <c:if
                                                                                            test="${selectedChildCategory == childCat.id}">
                                                                                            selected
                                                                                            </c:if>>
                                                                                            ${childCat.name}
                                                                                        </option>
                                                                            ...
                                                                            <div class="col-md-2 mb-3">
                                                                                <label for="sort" class="form-label">Sắp
                                                                                    xếp theo:</label>
                                                                                <select class="form-select" id="sort"
                                                                                    ...
                                                                                    <option value="price" <c:if
                                                                                        test="${sortBy == 'price'}">
                                                                                        selected
                                                                                        </c:if>>Giá</option>
                                                                                    <option value="createdAt" <c:if
                                                                                        test="${sortBy == 'createdAt'}">
                                                                                        selected</c:if>>Ngày tạo
                                                                                    </option>
                                                                                </select>
                                                                            </div>
                                                                            ...
                                                                            <div class="col-md-2 mb-3">
                                                                                <label for="direction"
                                                                                    class="form-label">Thứ tự:</label>
                                                                                <select class="form-select"
                                                                                    id="direction" name="direction">
                                                                                    <option value="asc" <c:if
                                                                                        test="${sortDirection == 'asc'}">
                                                                                        selected</c:if>>Tăng dần
                                                                                    </option>
                                                                                    <option value="desc" <c:if
                                                                                        test="${sortDirection == 'desc'}">
                                                                                        selected</c:if>>Giảm dần
                                                                                    </option>
                                                                                </select>
                                                                            </div>
                                                                ...
                                                                <div class="row mb-3">
                                                                    <div class="col-12">
                                                                        <p class="text-muted">
                                                                            Hiển thị ${products.numberOfElements} trên
                                                                            tổng ${totalElements} sản
                                                                            phẩm
                                                                            ...
                                                                            <c:if
                                                                                test="${selectedChildCategory != null}">
                                                                                    ...
                                                                                    <div
                                                                                        ...
                                                                                        <div class="card-body">
                                                                                            <div
                                                                                                ...
                                                                                                <c:choose>
                                                                                                    <c:when
                                                                                                        test="${not empty product.productUrl}">
                                                                                            ...
                                                                                            <div class="mt-2">
                                                                                                <div class="rating">
                                                                                                    ...
                                                                                                    <span
                                                                                                        class="text-muted">${product.ratingCount}
                                                                                                        Review</span>
                                                                                                    </small>
                                                                                                </div>
                                                                                            </div>
                                                                            ...
                                                                            <div class="col-12">
                                                                                <div class="alert alert-info text-center"
                                                                                    ...
                                                                                    <p>
                                                                                        <c:choose>
                                                                                            <c:when
                                                                                                test="${not empty keyword}">
                                                                                                Không có sản phẩm nào
                                                                                                phù hợp với từ khóa
                                                                                                "<strong>${keyword}</strong>".
                                                                                            </c:when>
                                                                                            <c:otherwise>
                                                                                                Danh mục này hiện tại
                                                                                                chưa có sản phẩm nào.
                                                                                            </c:otherwise>
                                                                                        </c:choose>
                                                                                    </p>
                                                                                    <a href="<c:url value='/category/${parentCategory.name.toLowerCase()}'/>"
                                                                                        class="btn btn-primary">Xem tất
                                                                                        cả sản phẩm</a>
                                                                                </div>
                                                                            </div>
                                                                        </c:otherwise>
                                                ...
                                                <div class="filter-section">
                                                    <form method="get"
                                                        ...
                                                        <div class="row">
                                                            <!-- Search Box -->
                                                            <div class="col-md-4 mb-3">
                                                                <label for="keyword" class="form-label">Tìm kiếm sản
                                                                    phẩm:</label>
                                                            ...
                                                            <!-- Category Filter -->
                                                            <div class="col-md-3 mb-3">
                                                                <label for="childCategory" class="form-label">Danh mục
                                                                    con:</label>
                                                            ...
                                                            <!-- Sort Options -->
                                                            <div class="col-md-2 mb-3">
                                                                <label for="sort" class="form-label">Sắp xếp
                                                                    theo:</label>
                                                                <select class="form-select" id="sort" name="sort">
                                                                    <option value="name" <c:if
                                                                        test="${sortBy == 'name'}">selected
                                                                        </c:if>>Tên</option>
                                                                    <option value="price" <c:if
                                                                        test="${sortBy == 'price'}">selected
                                                                        </c:if>>Giá</option>
                                                                    <option value="createdAt" <c:if
                                                                        test="${sortBy == 'createdAt'}">
                                                            ...
                                                            <!-- Sort Direction -->
                                                            <div class="col-md-2 mb-3">
                                                                <label for="direction" class="form-label">Thứ
                                                                    tự:</label>
                                                        ...
                                                        <c:otherwise>
                                                            <div class="col-12">
                                                                <div class="alert alert-info text-center" role="alert">
                                                                    <h4><i class="fas fa-info-circle"></i> Không tìm
                                                                        thấy sản phẩm
                                                                    </h4>
                                                                    <p>
                                                                        <c:choose>
                                                        ...
                                                        <div class="col-12">
                                                            <nav aria-label="Product pagination">
                                                                <ul class="pagination justify-content-center">
                                                                    <!-- Previous page -->
                                                                    <li class="page-item <c:if test=" ${!hasPrevious}">
                                                                        disabled
                                                </c:if>">
